  ...
  return (
    <div className="relative h-full">
      ...
      <div 
        className={`
          h-screen bg-sky-600
          shadow-2xl border-r border-white transition-all duration-300 ease-in-out z-50
      ...
      >
        ...
        <div className="flex flex-col items-center p-4 border-b border-white">
          ...
          <div className="flex items-center space-x-3 w-full">
            <img 
              ...
              alt="School Logo" 
              className="w-13 h-13 rounded-full object-cover border-2 border-white shadow-lg"
            />
            {!isCollapsed && (
              <div className="flex flex-col">
                <h1 className="text-white font-bold text-lg leading-tight">MMUST -</h1>
                <h2 className="text-white font-bold text-xs ">Student Portal</h2>
              </div>
            )}
          </div>
          ...
          {/* Toggle Button inside sidebar - Hidden when collapsed */}
            ...
            <button 
              onClick={toggleSidebar}
              className="absolute -right-3 top-6 bg-sky-700 hover:bg-blue-600 text-white rounded-full p-2 shadow-lg border border-blue-600 transition-all duration-200 hover:scale-110"
              ...
              <li key={key} className="relative">
                ...
                <div
                  className={`
                    ...
                    ${window.location.pathname === val.link ? 'bg-sky-600 shadow-lg' : 'hover:bg-sky-700'}
        ...
        `}>
          ...
          `}>
            {!isCollapsed ? (
              <div>
                <p className="font-semibold">© {new Date().getFullYear()} MMUST</p>
              </div>
            ) : (
