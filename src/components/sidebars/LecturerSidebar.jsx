      ...
      >
        ...
        <div className="flex flex-col items-center p-4 border-b border-blue-700">
          ...
          {/* Toggle Button inside sidebar - Hidden when collapsed */}
            ...
            <button 
              onClick={toggleSidebar}
              className="absolute -right-3 top-8 bg-blue-700 hover:bg-blue-600 text-white rounded-full p-2 shadow-lg border border-blue-600 transition-all duration-200 hover:scale-110"
